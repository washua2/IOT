    ...
    <div class="w-[44.625rem] h-[81.75rem] relative ">
      ...
      <div name="VVBIBONBGVIBN" v-if="switchStatus">
        ...
        <div class="w-[40.9375rem] h-[4.875rem] left-[1.875rem] top-[8.25rem] absolute" >
          <div class="w-[40.9375rem] h-[4.875rem] left-0 top-0 absolute rounded-[1rem] overflow-hidden border-[0.0625rem] border-white/20"
            style="background: linear-gradient(350deg, rgba(3, 23, 43, 0.30) -8.4%, rgba(0, 32, 62, 0.30) 106.15%); border: 0.125rem solid rgba(64, 64, 64, 0.20)">
          </div>
          <input placeholder="Search Camera ID"
            class="w-[35rem] left-[4.875rem] top-[1.4125rem] ipt absolute text-white/90 text-[1.75rem] font-normal font-['light'] leading-9 tracking-wide border-none bg-transparent outline-none"
      ...
      <div name="TXCVBNMGWNJIVB" v-else-if="!isCCTVUpdate">
        ...
        class="w-[44.625rem] h-[81.75rem] left-0 top-0 absolute rounded-lg border-2 border-white/20  overflow-hidden">
        <div class="w-[40.9375rem] h-[4.875rem] left-[1.875rem] top-[8.25rem] absolute">
          <div class="w-[40.9375rem] h-[4.875rem] left-0 top-0 absolute rounded border-[0.0625rem] border-white/20 "
      ...
      <div name="CVABANOFVBIB" v-else-if="isCCTVUpdate">
        ...
        class="w-[44.625rem] h-[81.75rem] left-0 top-0 absolute rounded-lg border-2 border-white/20  overflow-hidden">
        <div class="w-[40.9375rem] h-[4.875rem] left-[1.875rem] top-[8.25rem] absolute">
          <div class="w-[40.9375rem] h-[4.875rem] left-0 top-0 absolute rounded-[1rem] border-[0.0625rem] border-white/20"
            style="background: linear-gradient(350deg, rgba(3, 23, 43, 0.30) -8.4%, rgba(0, 32, 62, 0.30) 106.15%);">
          </div>
          <input placeholder="Search Camera ID"
            class="w-[35rem] left-[4.875rem] ipt top-[1.4125rem] absolute text-white/90 text-[1.75rem] font-['light'] leading-9 tracking-wide border-none bg-transparent outline-none"
            style="box-shadow: none;" />
          <div class="w-[1.875rem] h-[1.875rem] left-[1.5rem] top-[1.5625rem] absolute">
            <img class="w-full h-full" src="@/assets/icon/search.svg" alt="">
          </div>
        ...
        <div class="left-[1.875rem] top-[2.5rem] absolute">
          <div
            class="left-[4.875rem] top-[0.3125rem] absolute text-white text-[2rem] font-['semibold'] tracking-wide">
            CCTV</div>
          <div class="w-14 h-[3.125rem] left-0 top-0 absolute flex-col justify-start items-start inline-flex">
            <img class="w-full h-full" src="@/assets/icon/camera.svg" alt="">
          </div>
