...
export function renderChart(chartElementId, value) {
  ...
  const nameArr = ['7:00', '9:00', '13:00', '15:00', '17:00', '19:00'];
  const valueArr = [150, 60, 80, 180, 90, 200];
  ...
  var option = {
    ...
    xAxis: {
      ...
      //   show: true, // 显示网格线
      //   lineStyle: {
      //     color: 'rgba(255, 255, 255, 0.40)', // 竖线的颜色
      //     width: 1, // 网格线的宽度
      //     type: 'dashed', // 虚线
      //   },
      // },
    ...
    series: [
      ...
      },
      {
        ...
        symbolRotate: 0,
        symbolSize: [fontSizeRem(27), fontSizeRem(1)],
        symbolPosition: 'end',
        data: valueArr,
        z: 3,
      },
