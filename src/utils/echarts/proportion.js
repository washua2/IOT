...
export function renderChart(chartElementId, totalValue = 680) {
    ...
    // 示例数据（%）
    const seriesData = [
        { name: 'Sports & Competitions', value: 58, color: colors.c1 },
        { name: 'Entertainment & Cultural Shows', value: 22, color: colors.c2 },
        { name: 'National & Community Events', value: 12, color: colors.c3 },
        { name: 'Expos & InternationalEvents', value: 6, color: colors.c4 },
        { name: 'Maintenance / Downtime Periods', value: 2, color: colors.c5 }
    ];
    ...
    const option = {
        ...
        series: [
            ...
            {
                type: 'pie',
                radius: ['0%', '60%'],             // TODO: 内圆半径
                center: ['19%', '50%'],            // TODO: 整个环的位置（水平更靠左）
                silent: true,
                label: { show: false },
